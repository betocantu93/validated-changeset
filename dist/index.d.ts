...
import { Changes, Config, Content, Errors, IErr, IChangeset, INotifier, InternalMap, NewProperty, PrepareChangesFn, Snapshot, ValidationErr, ValidationResult, ValidatorAction, ValidatorMap } from './types';
...
export declare class BufferedChangeset implements IChangeset {
     ...
     * @method addError
     */
    addError<T>(key: string, error: IErr<T> | ValidationErr): string | string[] | IErr<T>;
    /**
